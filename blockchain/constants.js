...
export const QUICKMINT_FACTORY_ABI = [
	...
	},
	{
		...
		"outputs": [
			...
			{
				"internalType": "contract QuickMintCollection",
				"name": "userCollectionAddress",
				"type": "address"
			},
			{
				"internalType": "bool",
...
export const QUICKMINT_COLLECTION_ABI = [
	{
		"inputs": [
			{
				"internalType": "string",
